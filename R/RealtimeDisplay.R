...
callcam_server <- function(id, data) {
  moduleServer( id, function(input, output, session){
    ...
    img_path1 = "C:/Users/ElementXX/Desktop/RSTudioNshinYXX888/FrontEnd999XX/MRWFrontE999XX/BirdNETmonitor/dev/shm/img1.png"
    img_path2 = "C:/Users/ElementXX/Desktop/RSTudioNshinYXX888/FrontEnd999XX/MRWFrontE999XX/BirdNETmonitor/dev/shm/img2.png"
    img_path3 = "C:/Users/ElementXX/Desktop/RSTudioNshinYXX888/FrontEnd999XX/MRWFrontE999XX/BirdNETmonitor/dev/shm/img3.png"

    observeEvent(input$displayBtnUnit1, {
      download.file(urlUnit1, "C:/Users/ElementXX/Desktop/RSTudioNshinYXX888/FrontEnd999XX/MRWFrontE999XX/BirdNETmonitor/dev/shm/img1.png", mode = "wb")
    ...
    observeEvent(input$displayBtnUnit2, {
      download.file(urlUnit2, "C:/Users/ElementXX/Desktop/RSTudioNshinYXX888/FrontEnd999XX/MRWFrontE999XX/BirdNETmonitor/dev/shm/img2.png", mode = "wb")
    ...
    observeEvent(input$displayBtnUnit3, {
      download.file(urlUnit3, "C:/Users/ElementXX/Desktop/RSTudioNshinYXX888/FrontEnd999XX/MRWFrontE999XX/BirdNETmonitor/dev/shm/img3.png", mode = "wb")
